...
-(id)initwithArray:(NSArray*)data
{
    ...
    location=[NSString stringWithFormat:@"Event Location - %@",[data valueForKey:@"location"]];
...
-(id)initwithEKEvent:(EKEvent *)obj
{
   NSDateFormatter *dateFormatter=[[NSDateFormatter alloc] init];
    ...
    location=[NSString stringWithFormat:@"Event Location - %@",obj.location];
...
-(void)formatDate
{
  ...
  if([[year stringFromDate:_startDate] isEqualToString:[year stringFromDate:_endDate]])
    {
        if([[month stringFromDate:_startDate] isEqualToString:[month stringFromDate:_endDate]])
        {
            if([[day stringFromDate:_startDate] isEqualToString:[day stringFromDate:_endDate]])
                ...
                dates=[dates stringByAppendingFormat:@" - %@, %@, %@",[week stringFromDate:_endDate],[day stringFromDate:_endDate],[time stringFromDate:_endDate]];
        }
        else
        {
